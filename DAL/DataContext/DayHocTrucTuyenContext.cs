...
public partial class DayHocTrucTuyenContext : DbContext
{
    ...
    public virtual DbSet<GoiNangCap> GoiNangCaps { get; set; }
    ...
    public virtual DbSet<LopThuocTag> LopThuocTags { get; set; }
    ...
    public virtual DbSet<TrangThaiNangCap> TrangThaiNangCaps { get; set; }

    public virtual DbSet<ViNguoiDung> ViNguoiDungs { get; set; }

    public virtual DbSet<XemTrang> XemTrangs { get; set; }

    public virtual DbSet<YeuCauThanhToan> YeuCauThanhToans { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaBai).HasName("PK__BaiDang__3A5539EFA9FD8ECC");
            ...
            entity.HasOne(d => d.MaLopNavigation).WithMany(p => p.BaiDangs)
                .HasForeignKey(d => d.MaLop)
                .HasConstraintName("FK__BaiDang__Ma_Lop__628FA481");

            entity.HasOne(d => d.MaNdNavigation).WithMany(p => p.BaiDangs)
        ...
        {
            entity.HasKey(e => e.MaBaoCao).HasName("PK__BaoCao__5FC87B6E0AB07C38");
            ...
            entity.HasOne(d => d.MaNdNavigation).WithMany(p => p.BaoCaos)
                .HasForeignKey(d => d.MaNd)
        ...
        {
            entity.HasKey(e => new { e.MaNd, e.MaPhong }).HasName("PK__BiCamThi__015410DD21F62A1F");
            ...
            entity.HasOne(d => d.MaNdNavigation).WithMany(p => p.BiCamThis)
                .HasForeignKey(d => d.MaNd)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__BiCamThi__Ma_ND__73BA3083");

            entity.HasOne(d => d.MaPhongNavigation).WithMany(p => p.BiCamThis)
        ...
        {
            entity.HasKey(e => new { e.MaBai, e.MaNd, e.ThoiGian }).HasName("PK__BinhLuan__4176DE9182256901");
            ...
            entity.HasOne(d => d.MaBaiNavigation).WithMany(p => p.BinhLuans)
        ...
        {
            entity.HasKey(e => new { e.MaNd, e.MaBai }).HasName("PK__CamXuc__CDC7DE286C68564C");
            ...
            entity.HasOne(d => d.MaBaiNavigation).WithMany(p => p.CamXucs)
                .HasForeignKey(d => d.MaBai)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CamXuc__Ma_Bai__6E01572D");

            entity.HasOne(d => d.MaNdNavigation).WithMany(p => p.CamXucs)
                .HasForeignKey(d => d.MaNd)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Stt, e.MaPhong }).HasName("PK__CauHoiTh__E5282BFBECEAB9DA");
            ...
            entity.HasOne(d => d.MaPhongNavigation).WithMany(p => p.CauHoiThis)
                .HasForeignKey(d => d.MaPhong)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Stt, e.MaPhong, e.MaNd, e.LanThu }).HasName("PK__CauTraLo__1FE834025D55077E");
            ...
            entity.HasOne(d => d.MaNdNavigation).WithMany(p => p.CauTraLois)
                .HasForeignKey(d => d.MaNd)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CauTraLoi__Ma_ND__7A672E12");

            entity.HasOne(d => d.CauHoiThi).WithMany(p => p.CauTraLois)
        ...
        {
            entity.HasKey(e => e.MaDg).HasName("PK__DanhGiaL__2E67451C991DAB0A");
            ...
            entity.HasOne(d => d.MaLopNavigation).WithMany(p => p.DanhGiaLops)
                .HasForeignKey(d => d.MaLop)
                .HasConstraintName("FK__DanhGiaLo__Ma_Lo__5812160E");

            entity.HasOne(d => d.MaNdNavigation).WithMany(p => p.DanhGiaLops)
                .HasForeignKey(d => d.MaNd)
        ...
        {
            entity.HasKey(e => e.MaBai).HasName("PK__Ghim__3A5539EFF4B2AE1E");
            ...
            entity.HasOne(d => d.MaBaiNavigation).WithOne(p => p.Ghim)
        ...
        {
            entity.HasKey(e => e.MaGoi).HasName("PK__GoiNangC__3D0F91480CD9BB0A");
        ...
        {
            entity.HasKey(e => new { e.MaNd, e.MaLop }).HasName("PK__HocSinhT__E2596BF52ACB9466");
            ...
            entity.HasOne(d => d.MaLopNavigation).WithMany(p => p.HocSinhThuocLops)
                .HasForeignKey(d => d.MaLop)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HocSinhTh__Ma_Lo__5FB337D6");

            entity.HasOne(d => d.MaNdNavigation).WithMany(p => p.HocSinhThuocLops)
                .HasForeignKey(d => d.MaNd)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.MaNd, e.ThoiGian }).HasName("PK__LichSuGi__B23E77E64E7F767A");
            ...
            entity.HasOne(d => d.MaNdNavigation).WithMany(p => p.LichSuGiaoDiches)
                .HasForeignKey(d => d.MaNd)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.ThoiGian).HasName("PK__LichSuTr__C5CFA508D4F3D9DD");
            ...
            entity.HasOne(d => d.MaLopNavigation).WithMany(p => p.LichSuTruyCaps)
                .HasForeignKey(d => d.MaLop)
                .HasConstraintName("FK__LichSuTru__Ma_Lo__5BE2A6F2");

            entity.HasOne(d => d.MaNdNavigation).WithMany(p => p.LichSuTruyCaps)
                .HasForeignKey(d => d.MaNd)
        ...
        {
            entity.HasKey(e => e.MaLoai).HasName("PK__LoaiND__586312F96D194C92");
        ...
        {
            entity.HasKey(e => e.MaLop).HasName("PK__LopHoc__C3BE643D8DE3C9DF");

            entity.ToTable("LopHoc");

            entity.HasIndex(e => e.BiDanh, "UQ__LopHoc__7F28B28B55738035").IsUnique();
            ...
            entity.HasOne(d => d.MaNdNavigation).WithMany(p => p.LopHocs)
                .HasForeignKey(d => d.MaNd)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__LopThuoc__3214EC0755D9A821");
            ...
            entity.HasOne(d => d.MaLopNavigation).WithMany(p => p.LopThuocTags)
                .HasForeignKey(d => d.MaLop)
                .HasConstraintName("FK__LopThuocT__Ma_Lo__5441852A");

            entity.HasOne(d => d.MaTagNavigation).WithMany(p => p.LopThuocTags)
        ...
        {
            entity.HasKey(e => e.MaNd).HasName("PK__NguoiDun__2E628DB69C88F0CF");

            entity.ToTable("NguoiDung");

            entity.HasIndex(e => e.BiDanh, "UQ__NguoiDun__7F28B28B09F63ED7").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__NguoiDun__A9D10534A59F64A3").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaNd).HasName("PK__PheDuyet__2E628DB60EBDD481");
            ...
            entity.HasOne(d => d.MaNdNavigation).WithOne(p => p.PheDuyet)
        ...
        {
            entity.HasKey(e => e.MaPhong).HasName("PK__PhongThi__F369D6B36C267D0E");
            ...
            entity.HasOne(d => d.MaLopNavigation).WithMany(p => p.PhongThis)
                .HasForeignKey(d => d.MaLop)
        ...
        {
            entity.HasKey(e => e.MaTag).HasName("PK__Tag__C1AE337A6A9363A0");
        ...
        {
            entity.HasKey(e => e.MaYt).HasName("PK__ThichTra__2E62A20F5F19C71B");
            ...
            entity.HasOne(d => d.NguoiDungNavigation).WithMany(p => p.ThichTrangNguoiDungNavigations)
                .HasForeignKey(d => d.NguoiDung)
                .HasConstraintName("FK__ThichTran__Nguoi__403A8C7D");

            entity.HasOne(d => d.NguoiThichNavigation).WithMany(p => p.ThichTrangNguoiThichNavigations)
        ...
        {
            entity.HasKey(e => new { e.MaNd, e.MaPhong, e.LanThu }).HasName("PK__ThoiGian__DFB3C799E05002E9");
            ...
            entity.HasOne(d => d.MaNdNavigation).WithMany(p => p.ThoiGianLamBais)
                .HasForeignKey(d => d.MaNd)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ThoiGianL__Ma_ND__7E37BEF6");

            entity.HasOne(d => d.MaPhongNavigation).WithMany(p => p.ThoiGianLamBais)
                .HasForeignKey(d => d.MaPhong)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.MaTb, e.MaNd }).HasName("PK__ThongBao__5C84D3AE762A7E80");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__TinNhan__3214EC270B0E145B");
            ...
            entity.HasOne(d => d.NguoiGuiNavigation).WithMany(p => p.TinNhanNguoiGuiNavigations)
                .HasForeignKey(d => d.NguoiGui)
                .HasConstraintName("FK__TinNhan__Nguoi_G__3C69FB99");

            entity.HasOne(d => d.NguoiNhanNavigation).WithMany(p => p.TinNhanNguoiNhanNavigations)
        ...
        {
            entity.HasKey(e => e.MaNd).HasName("PK__TrangTha__2E628DB69D3A95F8");
            ...
            entity.HasOne(d => d.MaGoiNavigation).WithMany(p => p.TrangThaiNangCaps)
                .HasForeignKey(d => d.MaGoi)
                .HasConstraintName("FK__TrangThai__Ma_Go__33D4B598");

            entity.HasOne(d => d.MaNdNavigation).WithOne(p => p.TrangThaiNangCap)
        ...
        {
            entity.HasKey(e => e.MaNd).HasName("PK__ViNguoiD__2E628DB6207A831B");
            ...
            entity.HasOne(d => d.MaNdNavigation).WithOne(p => p.ViNguoiDung)
        ...
        {
            entity.HasKey(e => e.MaXt).HasName("PK__XemTrang__2E62DAEE2570E359");
            ...
            entity.HasOne(d => d.NguoiDungNavigation).WithMany(p => p.XemTrangNguoiDungNavigations)
                .HasForeignKey(d => d.NguoiDung)
                .HasConstraintName("FK__XemTrang__Nguoi___440B1D61");

            entity.HasOne(d => d.NguoiXemNavigation).WithMany(p => p.XemTrangNguoiXemNavigations)
        ...
        {
            entity.HasKey(e => new { e.MaNd, e.ThoiGian }).HasName("PK__YeuCauTh__B23E77E699C10F2F");
            ...
            entity.HasOne(d => d.MaNdNavigation).WithMany(p => p.YeuCauThanhToans)
                .HasForeignKey(d => d.MaNd)
                .OnDelete(DeleteBehavior.ClientSetNull)
